import { ArrowRight, FileText, Scale, Shield, Users, Zap } from "lucide-react";
        ...
        <div className="relative bg-card border border-border rounded-3xl p-12 md:p-16 overflow-hidden">
          ...
          <div className="text-center max-w-2xl mx-auto relative z-10">
            ...
            <p className="text-muted-foreground mb-8">
              Присоединяйтесь к 3 200+ предпринимателям, которые доверяют свои документы единственному ИИ, понимающему российское право.
            </p>
